...
//    @GetMapping("/")
    ...
    public ModelAndView index3(ModelAndView mav) {
        ...
        data.add(new String[]{"lee","lee@yamada","080-888-8888"});
        data.add(new String[]{"yun","yun@yamada","070-777-7777"});
    ...
    public ModelAndView index4(@PathVariable int tax, ModelAndView mav) {
